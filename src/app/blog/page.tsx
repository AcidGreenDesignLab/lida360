        ...
        <div className="max-w-7xl mx-auto px-6 w-full text-left">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post, idx) => (
              <div 
                key={idx}
                className="flex flex-col justify-between bg-[#FCFCFC] border-4 border-white rounded-lg shadow-2xl hover:border-accent-pink/30 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 overflow-hidden group cursor-pointer"
              >
                {/* Post Graphic */}
