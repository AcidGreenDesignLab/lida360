        ...
        <div className="max-w-7xl mx-auto px-6 w-full text-left">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {books.map((book, idx) => (
              <div 
                key={idx}
                className="bg-[#FCFCFC] p-8 border-4 border-white rounded-lg shadow-2xl flex flex-col md:flex-row items-center md:items-stretch gap-8 hover:border-accent-pink/30 transition-all duration-300"
              >
                {/* Book Cover Cover */}
