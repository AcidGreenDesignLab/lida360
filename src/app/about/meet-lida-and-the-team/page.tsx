        ...
        <div className="max-w-7xl mx-auto px-6 w-full text-left">
          ...
          <div className="flex flex-col gap-16 w-full">
            {team.map((member, idx) => (
              <div 
                key={idx}
                className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-[#FCFCFC] p-8 md:p-10 border-4 border-white rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300"
              >
                {/* Member Photo */}
