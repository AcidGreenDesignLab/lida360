      ...
      <section className="bg-bg-alt py-24 min-h-[750px] flex items-center border-t border-ui-muted/10">
        <div className="max-w-7xl mx-auto px-6 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Box 1: For Veterans */}
            <div className="bg-[#FCFCFC] p-8 border-4 border-white rounded-lg shadow-2xl flex flex-col justify-between hover:border-accent-pink/30 transition-all duration-300">
              <div>
