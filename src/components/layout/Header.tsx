...
export function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-[#0A112D]/50 backdrop-blur-md border-b border-glass-border shadow-[0_4px_30px_rgba(0,0,0,0.5)] px-6 py-4 flex items-center justify-between">
