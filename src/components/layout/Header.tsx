...
export function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-[#0A112D]/80 backdrop-blur-md border-b border-glass-border px-6 py-4 flex items-center justify-between">
      ...
      <div className="absolute top-full left-0 w-full h-8 bg-gradient-to-b from-black/35 to-transparent pointer-events-none" />
    </header>
  );
}